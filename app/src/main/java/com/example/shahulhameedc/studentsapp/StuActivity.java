...
public class StuActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            case R.id.stafid:
                Intent obj1 = new Intent(StuActivity.this, StaffActivity.class);
                startActivity(obj1);
                break;
            case R.id.admid:
                Intent cityMap3 = new Intent(StuActivity.this, AdminActivity.class);
                startActivity(cityMap3);
                break;
            case R.id.hmid:
                Intent cityMap = new Intent(StuActivity.this, MainActivity.class);
